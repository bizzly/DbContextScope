...
{
    public interface ITenantAwareDbContextScopeFactory
    {
        /// <summary>
        ...
        /// </summary>
        IDbContextScope Create(int tenantId, DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
        ...
        /// implications of doing this.
        /// </summary>
        IDbContextReadOnlyScope CreateReadOnly(int tenantId, DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
        ...
        /// </summary>
        IDbContextScope CreateWithTransaction(int tenantId, IsolationLevel isolationLevel);
        ...
        /// and only if you fully understand the implications of doing this.
        /// </summary>
        IDbContextReadOnlyScope CreateReadOnlyWithTransaction(int tenantId, IsolationLevel isolationLevel);
