...
using Numero3.EntityFramework.Demo.BusinessLogicServices.NetCore;
using Numero3.EntityFramework.Demo.CommandModel.NetCore;
using Numero3.EntityFramework.Demo.DatabaseContext.NetCore;
using Numero3.EntityFramework.Demo.Repositories.NetCore;
using System;
using System.Linq;

namespace Demo.NetCore2._2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var dbContextScopeFactory = new TenantAwareDbContextScopeFactory(new DbContextFactory());
            var ambientDbContextLocator = new TenantAwareAmbientDbContextLocator();


            var t = dbContextScopeFactory.Create(13);
